...
//Paramaters - an interger that is non-negative indicating a couunt of seconds, which are basic units on our clocks. The max num of seconds will be 359999 or less.

//Return - a clock value containing hours, min, secs, with the specific format of HH:MM:SS, with values of 9 and below having a leading 0
...
//Pseudo
// Take an integer and divide by 60 the appropriate amount of times and assign the result to hours, min, seconds. Pad leading 0's where needed and print hours, minutes, seconds with a colon between them
